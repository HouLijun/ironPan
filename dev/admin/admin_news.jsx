...
class List extends React.Component {
    ...
    /*删除*/
    delete(){
        fetch(`/admin/news/${this.state.cate_id}/${this.state.id}`,{
            method:"POST",
            credentials: 'same-origin',
            headers:{
                "Content-Type":"application/json"
            ...
            <Col span="8" key={1}>
                <Card bordered={false}>
                    ...
                    <div className="inputName btn-delete" onClick={this.delete}>
                        <a href={`/admin/news/${this.state.cate_id}`}>
                            <Button>删除</Button>
                        </a>
                    </div>
                </Card>
...
class Content extends React.Component {
    ...
    /*增加*/
    add(e){
        fetch(`/admin/news_add/${this.state.cate_id}`,{
            method: 'POST',
            credentials: 'same-origin',
            headers: {
                'Content-Type': 'application/json'
...
ReactDOM.render(<Content/>, document.querySelector('#news'));