...
class List extends React.Component {
    ...
    /*删除*/
    delete(){
        fetch(`/admin/upkeep/${this.state.cate_id}/${this.state.id}`,{
            method:"POST",
            credentials: 'same-origin',
            headers:{
                "Content-Type":"application/json"
        ...
        const nnn = {
            ...
            onChange(info) {
                ...
                if (info.file.status === 'done') {
                    ...
                    location.href=`/admin/upkeep/${cate}`
            ...
            <Col span="8" key={1}>
                <Card bordered={false}>
                    ...
                    <div className="inputName btn-delete" onClick={this.delete}>
                        <a href={`/admin/upkeep/${this.state.cate_id}`}>
                            <Button>删除</Button>
                        </a>
                    </div>
                </Card>
...
class Content extends React.Component {
    ...
    /*增加*/
    add(e){
        fetch(`/admin/upkeep_add/${this.state.cate_id}`,{
            method: 'POST',
            credentials: 'same-origin',
            headers: {
                'Content-Type': 'application/json'
...
ReactDOM.render(<Content/>, document.querySelector('#upkeep'));